   ...
   <script type="application/ld+json">
    {
      ...
      "@type": "WebPage",
      "name": "WilaWane",
      "url": "https://www.wilawane.com",
      "image": "https://www.wilawane.com/assets/img/apple-touch-icon.png",
      "description": "WilaWane Store is a registered wooden educational toys and bookstore, the first of its kind in Zambia.",
      "publisher": {
        "@type": "Organization",
        "name": "WilaWane",
        "logo": {
          "@type": "ImageObject",
          "url": "https://www.wilawane.com/assets/img/apple-touch-icon.png"
        }
      }
    }
    </script>
...
<body>
  ...
  <section id="hero-animated" class="hero-animated d-flex align-items-center">
    <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
      <img src="{{ asset('assets/img/apple-touch-icon.png') }}" class="img-fluid animated">
  </section>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row g-4 g-lg-5" data-aos="fade-up" data-aos-delay="200">
          <div class="col-lg-5">
            <div class="about-img">
              <img src="{{ asset('assets/img/zeya.jpg') }}" class="img-fluid" alt="Zela" style="border-radius: 5%;">
            </div>
          </div>
          <div class="col-lg-7">
      ...
      <div class="container" data-aos="zoom-out">
        <div class="row g-5">
          <div class="col-lg-8 col-md-6 content d-flex flex-column justify-content-center order-last order-md-first">
            <h3 style="color:black;">Visit <span style="color:#fc32c3;">WilaWane</span> Store</h3>
            <p style="color:black;"> Experience the magic of WilaWane Store by clicking on the button below now! Discover a world of wooden educational toys and captivating books, the first of its kind in Zambia.</p>
            <a class="cta-btn align-self-start" style="background-color:#fc32c3; color:white;" href="">WilaWane Store</a>
          </div>
            ...
            <div id="imageCarousel" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="{{ asset('assets/img/juanita.jpg') }}" alt="Image 2" class="img-fluid">
                </div>
                <div class="carousel-item">
                  <img src="{{ asset('assets/img/kids.jpg') }}" alt="Image 3" class="img-fluid">
                </div>
                <div class="carousel-item">
                  <img src="{{ asset('assets/img/kids2.jpg') }}" alt="Image 4" class="img-fluid">
                </div>
                <div class="carousel-item">
                  <img src="{{ asset('assets/img/kids3.jpg') }}" alt="Image 5" class="img-fluid">
                </div>
              </div>
        ...
        <div class="tab-content">
          <div class="tab-pane active show" id="tab-1">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center" data-aos="fade-up" data-aos-delay="200">
                <img src="{{ asset('assets/img/wooden.jpg') }}" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-2">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="{{ asset('assets/img/montessori.jpg') }}" alt="montessori" class="img-fluid" width="100" height="200">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-3">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="{{ asset('assets/img/felt.jpg') }}" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="{{ asset('assets/img/furniture.png') }}" alt="" class=" img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-5">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="{{ asset('assets/img/stem.jpg') }}" alt="" class=" img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-6">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="{{ asset('assets/img/books.jpg') }}" alt="" class="img-fluid">
              </div>
            </div>
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-header text-center">
          ...
          <p style="color: black;">At Wila Wane Store, our success is a result of the dedicated and talented individuals who make up our exceptional team. Each member contributes unique skills and expertise, creating a dynamic and collaborative work environment. Meet the visionaries behind our brand:
            ...
            Discover more about the minds shaping the future of Wila Wane Store, each contributing to our shared mission of delivering outstanding products and services.
          </p>
        </div>
        <div class="row gy-5 justify-content-center">
          <div class="col-xl-4 col-md-6 d-flex" data-aos="zoom-in" data-aos-delay="200">
            <div class="team-member">
              <div class="member-img">
                <img src="{{ asset('assets/img/kayanda.png') }}" class="img-fluid" alt="">
              </div>
          ...
          <div class="col-xl-4 col-md-6 d-flex" data-aos="zoom-in" data-aos-delay="400">
            <div class="team-member">
              <div class="member-img">
                <img src="{{ asset('assets/img/peter.png') }}" class="img-fluid" alt="">
              </div>
              <div class="member-info">
                <div class="social">
            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
              <div class="post-box">
                <div class="post-img-container">
                  <img src="{{ $post['image'] }}" class="img-fluid" alt="No Image added">
                </div>
                <div class="post-content">
                  <div class="meta">
                    <span class="post-date">{{ \Carbon\Carbon::parse($post['date'])->format('D, M j, Y H:i') }}</span>
                    <span class="post-author"> / {{ $post['author'] }}</span>
                  </div>
                  <h3 class="post-title" style="color:black;">{{ $post['title'] }}</h3>
                  <p class="post-excerpt">{{ \Illuminate\Support\Str::limit($post['content'], 100, '...') }}</p>
                  <a href="{{ url('blog-details/' . $post['id']) }}" class="readmore stretched-link"><span style="color:#f9d030;">Read More</span><i style="color:#f9d030;" class="bi bi-arrow-right"></i></a>
                </div>
              </div>
            </div>
          @endforeach
    ...
    <section id="contact" class="contact">
      ...
      <div class="container">
        <div class="row gy-5 gx-lg-5">
          ...
          <div class="col-lg-8">
            <form action="{{ url('contacts') }}" method="post" role="form" class="php-email-form">
              @csrf
              <div class="row">
    ...
    <div class="footer-legal text-center">
      <div class="container d-flex flex-column flex-lg-row justify-content-center justify-content-lg-between align-items-center">
        ...
        <div class="social-links order-first order-lg-last mb-3 mb-lg-0">
          <a href="https://m.facebook.com/pages/Wila-Wane-Store/106955238955872/?locale=hi_IN" class="facebook"><i style="color: #f9d030" class="bi bi-facebook"></i></a>
          <a href="https://www.instagram.com/wilawane_store" class="instagram"><i style="color: #f9d030" class="bi bi-instagram"></i></a>
          <a href="https://l.instagram.com/?u=https%3A%2F%2Fwa.me%2F260975520847&e=AT29F0ZTN12zGL0_5jvEVaggF0EcbLbAbmH3NIbXHDlJXls5Xu9Hom-MJGSgM7ee-PH45Rshp_wnabKY3nhO9jTgZkZQT5abRtlxGw" class="whatsapp"><i style="color: #f9d030" class="bi bi-whatsapp"></i></a>
        </div>
      </div>
    </div>
    </div>
